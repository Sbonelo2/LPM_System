...
const QAPlacements: React.FC = () => {
  ...
  return (
    <div className="programme-coordinator-page qa-placements-page">
      <div className="page-header">
        <h1 className="page-title">QA Officer - Placements</h1>
        <div className="design-badge">QA Officer - Design</div>
      </div>
